...
**Naming update (Pierre's second annotation pass):** the exercise shipped as a full-page fill-out scoresheet, **"The Work Order Quality Quiz"** (picked from Pierre's alliteration list | "Quality Quiz"), page 6, tag FSN-QUIZ-03, "photocopy freely."  Cosmo-style verdict personas: The Documentation Darling (8 or 9), The Almost-There Operator (5 to 7), The "Fixed." Philosopher (0 to 4).  Sample total bands: 140+ AI-ready | 90 to 139 closure discipline first | under 90 training budget.  Standalone export: web/brand/work-order-quality-quiz.png.
